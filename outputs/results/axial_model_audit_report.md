...
- Local source commit: `80b2598a45a40cfbfacbdabb4c5cb1adc705292b` (the run metadata separately records whether the tree was dirty).
...
- Three-resolution growing-mode survivors: `0`.
