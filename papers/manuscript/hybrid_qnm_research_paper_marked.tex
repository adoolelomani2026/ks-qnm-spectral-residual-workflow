...
The scalar fundamentals decrease successively across the four sampled
deformation values.
...
numerically distinct frequency-domain methods. The scalar fundamentals decrease
successively across the four sampled deformation values. For \(\ell=2\) at
\(a/M=1\), the oscillation
