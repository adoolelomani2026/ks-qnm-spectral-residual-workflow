...
indicating increased local numerical sensitivity rather than an instability.
...
release \texttt{cqg-r2-final-v2} at
\url{https://github.com/adoolelomani2026/ks-qnm-spectral-residual-workflow/releases/tag/cqg-r2-final-v2}.
\color{black}
...
\color{blue}
OpenAI Codex, model identifier \texttt{gpt-5.6-sol}, was used during
June--July 2026 to assist with code generation, debugging and refactoring,
