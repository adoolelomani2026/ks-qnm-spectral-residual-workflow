...
\end{center}
The repository contains the Chebyshev spectral solver, the Leaver-style validation layer, catalogue-generation scripts, generated tables, manuscript-supporting figures, and automated tests. The default validation entry point is the test suite; full catalogue regeneration is driven by the main algorithm script in \texttt{scripts/}.
