...
Kazakov--Solodukhin (KS) geometry using Chebyshev collocation and a
collocation-independent Frobenius continued fraction. Generalized-eigenvalue roots are retained only
...
18 literature targets listed in Appendix~\ref{tab:schwarzschildseeds}; no
...
numerically distinct frequency-domain methods. The scalar fundamentals soften steadily
...
separate Chebyshev calculation \cite{BaticDutykhSukaiti2026}, but their
