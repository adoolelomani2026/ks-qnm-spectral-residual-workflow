...
We compute quasinormal modes (QNMs) of Kazakov-Solodukhin (KS) black holes using a Chebyshev-Leaver spectral residual workflow. The finite Chebyshev operator is audited through its smallest singular value, branch continuation, convergence with spectral size N, and Leaver-style continued fractions. The Schwarzschild scalar l=2 fundamental QNM is recovered at N=96 with relative error 1.462e-10. The validated catalogue covers scalar and lapse-deformed axial-gravitational l=2,3,4 modes through n=2, with worst Leaver-spectral difference 1.097e-5. At fixed mass, the sampled KS branches soften. For the scalar l=2, n=0 branch at a/M=1, the oscillation frequency, damping magnitude, and quality factor shift by -7.29\%, -2.59\%, and -4.83\%, respectively. A finite-N singular-value pseudospectral diagnostic of the same branch also broadens: at N=64, the 10\% quantile susceptibility increases by 0.161, and the deepest local contour area grows by a factor 5.06. The scalar sector provides the most robust physics result; the axial sector remains phenomenological because it is not derived from gauge-invariant KS perturbation equations.
